...
const SolutionVisual = ({ solution, className }: SolutionVisualProps) => {
  ...
  return (
    <div
      className={cn(
        "relative overflow-hidden rounded-[1.75rem] bg-[radial-gradient(circle_at_top_left,rgba(34,211,238,0.35),transparent_28%),linear-gradient(140deg,#09121f_0%,#102137_55%,#172c43_100%)]",
        className,
      )}
    >
      ...
      <div className="relative flex h-full min-h-[240px] flex-col justify-between p-7 text-white">
        <div className="flex items-start justify-between gap-4">
          <div className="rounded-2xl border border-white/10 bg-white/10 p-4 backdrop-blur-sm">
            <Icon className="h-8 w-8 text-cyan-200" strokeWidth={1.7} />
          </div>
